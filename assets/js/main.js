...
=============================================*/
    ...
    form.addEventListener("submit", function(event) {
        ...
        // Optionally validate the form (example: check if all fields are filled)
        if (!name || !email || !phone || !subject || !message) {
            alert("Please fill in all fields.");
            return;
        }
		// Optionally, you can add more validation here (e.g., email format)
		// Example of sending the form data to a backend service
        ...
        // Display the form data (You can send this data to a backend service or an email)
        ...
        // Show a success message (or redirect to a thank you page, etc.)
        alert("Your message has been sent successfully!");
